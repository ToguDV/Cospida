...
public class Dialog : MonoBehaviour
{
    ...
    public bool lockAttackPlayer;
    public bool lockMovePlayer;
    public bool lockDashPlayer;
    ...
    void OnEnable()
    {
        PlayerController.isOnCinematic = true;
        if (!first)
        {
            textDisplay.text = "";
            index = 0;
    ...
    {
        PlayerController.isOnCinematic = false;
        if (lockDashPlayer)
        {
